#!/usr/bin/env python3
"""Zip + publish galaxycraft to the UEFN Ducky Store via uds_release.
...
Usage:
  ...
  py scripts/release.py --publish --changelog "v1: Galaxy Craft theme"
"""
...
def publish(zip_path: Path, *, category: str, changelog: str) -> None:
    ...
    try:
        ...
        # Key may lack the manage-category scope; uds_release creates it as needed.
...
def main() -> None:
    ...
    parser.add_argument("--sync-seed", action="store_true", help="Sync into frontend/uefn_plugins/galaxycraft")
